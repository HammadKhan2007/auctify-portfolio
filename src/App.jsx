...
const INITIAL_PRODUCTS = [
  ...
  },
  {
    ...
    category: 'Furniture',
    image: 'https://images.unsplash.com/photo-1540574163026-643ea20d25b5?auto=format&fit=crop&w=800&q=80',
    currentBid: 1850,
  ...
  },
  {
    ...
    category: 'Car',
    image: 'https://images.unsplash.com/photo-1503376713356-dd09000a6042?auto=format&fit=crop&w=800&q=80',
    currentBid: 245000,
...
function VendorDashboard({ products, setProducts, navigateTo, user, addToast }) {
  ...
  const handleSubmit = (e) => {
    ...
    const newProduct = {
      ...
      title,
      category,
      image: image || 'https://images.unsplash.com/photo-1553440569-bcc63803a83d?auto=format&fit=crop&w=800&q=80',
